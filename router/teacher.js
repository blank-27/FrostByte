...
router.get('/home/teacher',checkAuthenticated,isVerified,async(req,res)=>{
    ...
    res.render('teacher',{name:req.user.name,email:req.user.email,coaching:req.user.coaching,image:req.user.avatar,assignments,link,err:res.locals.error,error:res.locals.error_message,success:res.locals.success_messagge});
})
